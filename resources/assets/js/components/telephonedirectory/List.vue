            ...
            <template slot="table-row" slot-scope="props">
                <div class="w-full flex justify-between">
                    ...
                    <div v-if="props.column.field == 'action' && props.row.type== 'telephone_directory' " class="w-full flex items-center">
                        <a :href="'/' + mode + '/phonenumber/edit/' + props.row.id" title="Edit">
...
<script>
    ...
    export default {
        ...
        methods:
        {
            getData()
            {
                axios.get('/'+this.mode+'/phonenumber/list').then(response => {
            ...
            deleteNumber(id) 
            {
                ...
                swal({
                    ...
                    if (isConfirm) 
                    {
                        axios.get(thisswal.url+ '/'+thisswal.mode+'/phonenumber/delete/'+ id).then(response => {
